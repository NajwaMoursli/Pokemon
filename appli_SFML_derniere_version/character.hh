...
public:
	...
	std::vector<sf::Vector2<int>> get_indEdges(TileMap& carte, int x, int y);
	bool inObstacleTile(TileMap& carte, const int* tiles,const int* tiles2, std::vector<sf::Vector2<int>> indEdges, int& intersectX, int& intersectY);
